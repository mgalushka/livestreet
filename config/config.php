...
$config['sys']['mail']['from_name']        = $config['view']['name'];  // Имя с которого отправляются все уведомления
 ...
 * Языковые настройки
 */
$config['lang']['current'] = 'ukrainian';                                                // текущий язык текстовок
$config['lang']['default'] = 'ukrainian';                                                // язык, который будет использовать на сайте по умолчанию
